...
function OrderForm4(props) {
  ...
  return (
    <div>
      <div className={"sub-title"}>Order Information</div>
      ...
      <div>
        ...
        <div className={"high-bold"}>
          {" "}
          ({info["weight"]}Kg, {info["length"]}cm * {info["width"]}cm *{" "}
          {info["height"]}cm){" "}
        </div>
        ...
        <div>
          {" "}
          Total express fee is <span className={"high-bold"}> {price}$ </span>
        </div>
      ...
      <div>
        <Row justify={"space-between"}>
          <Col>
            <Button type={"default"} onClick={onClickPrevious} shape={"round"}>
              <LeftCircleOutlined />
              Previous
            </Button>
          </Col>
          ...
          <Col>
            <Button type={"primary"} onClick={onClickNext} shape={"round"}>
              Review
              <RightCircleOutlined />
            </Button>
          </Col>
