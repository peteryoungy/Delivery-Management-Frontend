  ...
  return (
    <div>
      ...
      <GoogleMap mapContainerStyle={containerStyle} center={center} zoom={14}>
        ...
        {Object.keys(senderPos).length === 0 ? null : (
          <Marker icon={userIcon} position={senderPos} />
        )}

        {Object.keys(receiverPos).length === 0 ? null : (
          <Marker icon={userHIcon} position={receiverPos} />
        )}
        {station !== -1 && Object.keys(receiverPos).length !== 0 && (
          <DirectionsService
            // required
            options={{
